...
?></h5> 
 ...
 <br><br><br>
  ...
  ?>
    ...
    <a href="pdfdatalengkap.php" target="_blank" class="btn btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp PRINT DATA INI</a>
</div>
		...
		<table id="getTable" class="table table-bg-3 bg-3 table-stripped">
          ...
          <tbody >
			...
			<?php 
      $no = 1;
				$data = mysqli_query($config,"select * from data_lengkap order by nama asc");
