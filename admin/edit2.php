...
<br><br><br>
    ...
    <div class="sticky-top card shadow p-3 mb-3 mt-3 bg-dark vh-100">
		...
		<?php
			$id = $_GET['id'];
			$data = mysqli_query($config,"select * from data_tabungan where no_tabungan='$id'");
		...
		<div class="ms-3 me-3 pb-3">
        	<form method="POST" action="">
              ...
              <div class="col">
                    	<div class="mb-3">
                			<label class="form-label text-white">Nomor Tabungan</label>
							 
                  			<input value="<?php echo $edit["no_tabungan"] ;?>" name="no_tabungan" type="varchar" class="form-control form-control-sm">
                        </div>
                	<div class="col">
                    	<div class="mb-3">
                	...
                	<div class="col">
                    	<div class="mb-3">
                			<label class="form-label text-white">Saldo</label>
                  			<input value="<?php echo $edit["saldo"] ;?>" name="saldo" type="varchar" class="form-control form-control-sm">
                        </div>
                	</div>
              ...
              <a href="index.php" class="form-control btn btn-info btn-sm ms-1">Batal</a>
